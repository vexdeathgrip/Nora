...
def finalize_turn(
    ...
    *,
    ...
    # Todo list loop: if there are pending todos, re-invoke to continue
    if final_response and not interrupted and "todo_list" in agent.valid_tool_names:
        try:
            import sys
            ...
            if pending:
                ...
                if _cont_count < 3:
                    ...
                    agent._todo_loop_continuation = True
        except Exception:
            pass
