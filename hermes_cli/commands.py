...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("update", "Update Nora to the latest version", "Info"),
    CommandDef("version", "Show Nora version", "Info", aliases=("v",)),
...
def _telegram_command_menu_config() -> dict:
    """Return the Telegram command-menu config with safe defaults."""
    try:
        from hermes_cli.config import load_config
        cfg = load_config() or {}
        menu_cfg = ((cfg.get("platforms") or {}).get("telegram") or {}).get("extra") or {}
        menu_cfg = menu_cfg.get("command_menu") or {}
    except Exception:
        menu_cfg = {}
