...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Nora"                    # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Nora"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Nora — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Nora",
            "welcome": "Welcome to Nora! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Nora ",
            "prompt_symbol": "❯",
